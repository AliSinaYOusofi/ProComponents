        ...
        <div className="space-y-6">
                ...
                <div>
                    ...
                    >
                        ...
                        <span
                            className={`transform transition-transform duration-200 ${
                                openItems["default-1"] ? "rotate-180" : ""
                            }`}
                        >
                            {icons.chevronDown}
                        </span>
                    ...
                    <div
                        className={`transition-all duration-200 ${
                            openItems["default-1"] ? "max-h-40" : "max-h-0"
                        } overflow-hidden`}
                    >
                        <div className="p-4 pt-0">
                            <p className="text-gray-600 dark:text-gray-400">
                                ProComponents is a comprehensive UI library
            ...
            <div className="space-y-2">
                <div className="border border-gray-200 dark:border-gray-700 rounded-lg">
                    ...
                    <div
                        className={`transition-all duration-200 ${
                            openItems["icon-1"] ? "max-h-40" : "max-h-0"
                        } overflow-hidden`}
                    >
                        <div className="p-4 border-t border-gray-200 dark:border-gray-700">
                            <p className="text-gray-600 dark:text-gray-400">
                                Learn more about our product features and
                                capabilities.
                            </p>
                        </div>
                    </div>
            ...
            <div className="space-y-3">
                <div className="bg-gray-50 dark:bg-gray-800 rounded-xl">
                    ...
                    >
                        ...
                        <span
                            className={`transform transition-transform duration-200 ${
                                openItems["rounded-1"] ? "rotate-180" : ""
                            }`}
                        >
                            {icons.chevronDown}
                        </span>
                    ...
                    <div
                        className={`transition-all duration-200 ${
                            openItems["rounded-1"] ? "max-h-40" : "max-h-0"
                        } overflow-hidden`}
                    >
                        <div className="px-4 pb-4">
                            <p className="text-gray-600 dark:text-gray-400">
                                Choose from our flexible pricing plans for your
                                needs.
                            </p>
                        </div>
                    </div>
            ...
            <div className="space-y-3">
                <div className="bg-primary-50 dark:bg-primary-900/20 border border-primary-200 dark:border-primary-800 rounded-lg">
                    ...
                    >
                        ...
                        <span
                            className={`transform transition-transform duration-200 text-primary-500 ${
                                openItems["colored-1"] ? "rotate-180" : ""
                            }`}
                        >
                            {icons.chevronDown}
                        </span>
                    ...
                    <div
                        className={`transition-all duration-200 ${
                            openItems["colored-1"] ? "max-h-40" : "max-h-0"
                        } overflow-hidden`}
                    >
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="border border-gray-200 dark:border-gray-700 rounded-lg">
                ...
                <div
                    className={`transition-all duration-200 ${
                        openItems["list-1"] ? "max-h-60" : "max-h-0"
                    } overflow-hidden`}
                >
                    <div className="p-4 border-t border-gray-200 dark:border-gray-700">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                <div className="divide-y divide-gray-200 dark:divide-gray-700">
                    <div>
                        ...
                        <div
                            className={`transition-all duration-200 ${
                                openItems["card-1"] ? "max-h-40" : "max-h-0"
                            } overflow-hidden`}
                        >
                            <div className="p-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50">
                                <p className="text-gray-600 dark:text-gray-400">
                                    Access premium features and priority
                                    support.
                                </p>
                            </div>
                        </div>
        ...
        <div className="space-y-6">
            ...
            <div className="border border-gray-200 dark:border-gray-700 rounded-lg divide-y divide-gray-200 dark:divide-gray-700">
                <div>
                    ...
                    <div
                        className={`transition-all duration-200 ${
                            openItems["faq-1"] ? "max-h-40" : "max-h-0"
                        } overflow-hidden`}
                    >
                        <div className="p-4 pt-0">
                            <p className="text-gray-600 dark:text-gray-400">
                                You can reach our support team through email,
            ...
            <div className="space-y-2">
                <div className="border border-gray-200 dark:border-gray-700 rounded-lg">
                    ...
                    <div
                        className={`transition-all duration-200 ${
                            openItems["steps-1"] ? "max-h-40" : "max-h-0"
                        } overflow-hidden`}
                    >
                        <div className="p-4 border-t border-gray-200 dark:border-gray-700">
                            <p className="text-gray-600 dark:text-gray-400">
                                Install the package using npm or yarn package
                                manager.
                            </p>
                        </div>
                    </div>
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-3">
                <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                    ...
                    >
                        ...
                        <span
                            className={`transform transition-transform duration-200 text-blue-500 ${
                                openItems["notification-1"] ? "rotate-180" : ""
                            }`}
                        >
                            {icons.chevronDown}
                        </span>
                    ...
                    <div
                        className={`transition-all duration-200 ${
                            openItems["notification-1"] ? "max-h-40" : "max-h-0"
                        } overflow-hidden`}
                    >
                        <div className="p-4 border-t border-blue-200 dark:border-blue-800">
                            <p className="text-blue-700 dark:text-blue-300">
                                A new system update is available with
            ...
            <div className="border border-gray-200 dark:border-gray-700 rounded-lg">
                ...
                <div
                    className={`transition-all duration-200 ${
                        openItems["toc-1"] ? "max-h-60" : "max-h-0"
                    } overflow-hidden`}
                >
                    <div className="p-4 border-t border-gray-200 dark:border-gray-700">
                        <ul className="space-y-2">
...
export default function AccordionShowcase() {
    return (
        <>
            <Head>
                <title>
                    React Accordion Components - Interactive Accordion Showcase
                </title>
                <meta
                    name="description"
                    content="Explore our comprehensive collection of React accordion components featuring various styles and interactive effects."
                />
                <meta
                    name="keywords"
                    content="react accordions, UI components, interactive accordions, customizable accordions"
                />
                <meta
                    property="og:title"
                    content="React Accordion Components - Interactive Accordion Showcase"
                />
                <meta
                    property="og:description"
                    content="Collection of React accordion components with various styles"
                />
                ...
                <meta
                    ...
                    content="Explore our collection of React accordion components"
                />
            </Head>
            <main
                className="accordion-showcase"
                role="main"
                aria-label="Accordion Components Showcase"
            >
                <h1 className="sr-only">React Accordion Components Showcase</h1>
                <div className="space-y-8">
                    <section aria-labelledby="basic-accordions-title">
                        <h2
                            id="basic-accordions-title"
            ...
            <div className="p-4 border-t border-primary-200 dark:border-primary-800">
                <p className="text-primary-700 dark:text-primary-300">
                    ...
                    <section aria-labelledby="interactive-accordions-title">
                        <h2
                            id="interactive-accordions-title"
                            className="text-lg font-semibold mb-4"
                        >
            ...
            <div className={\`transition-all duration-200 \${openItems['card-1'] ? 'max-h-40' : 'max-h-0'} overflow-hidden\`}>
                <div className="p-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50">
                    ...
                    <section aria-labelledby="functional-accordions-title">
                        <h2
                            id="functional-accordions-title"
                            className="text-lg font-semibold mb-4"
                        >
            ...
            <div className="p-4 border-t border-gray-200 dark:border-gray-700">
                <p className="text-gray-600 dark:text-gray-400">
                    ...
                    <section aria-labelledby="special-accordions-title">
                        <h2
                            id="special-accordions-title"
                            className="text-lg font-semibold mb-4"
                        >
                            Special Purpose Accordions
                        </h2>
                        <ComponentPreview
